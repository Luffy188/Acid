...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/Acid.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/Acid.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python Acid.py')
        tks = ('Hello%20Acid%20Owner%20Kashif%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213771372932?text='+tks)

    r1 = requests.get('https://github.com/Luffy188/Almok/blob/main/Aproval.txt').text
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20Acid%20Owner%20Acid-XD%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213771372932?text='+tks)
        main_apv()
main_apv()
